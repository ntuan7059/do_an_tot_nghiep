...
\setglossarystyle{long} % hoặc mystyle nếu cần
...
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{GIẢI PHÁP, ĐÓNG GÓP VÀ KẾT LUẬN}
\label{chapter:SolutionContributionConclusion}
